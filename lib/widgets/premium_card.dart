/// Premium Card Widget - Modern design with multiple style options and new design system
...
class _PremiumCardState extends State<PremiumCard>
  ...
  Widget _buildCard() {
    ...
    final bgColor = widget.backgroundColor ?? AppColors.premiumBlue;
    final borderCol = widget.borderColor ?? AppColors.liquidCyan.withValues(alpha: 0.2);
  ...
  Widget _buildFilledCard(Widget cardContent, Color bgColor) {
    return Container(
      ...
      height: widget.height,
      decoration: BoxDecoration(
        gradient: widget.gradient ?? AppGradients.premium,
